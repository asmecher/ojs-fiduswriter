	...
	<tr valign="top">
		...
		<td class="value" width="80%">
			<form method="post" action="{$apiUrl}">
				...
				{/foreach}
				<input type="submit" value="{translate key="plugins.generic.fidusWriter.revise"}" class="button defaultButton" />
				<p>{translate key="plugins.generic.fidusWriter.revise.description"}</p>
			</form>
		</td>
	</tr>
</table>
